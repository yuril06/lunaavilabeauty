...
export default function WhatsAppFloatingButton({ phone }: { phone: string }) {
  ...
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-charcoal text-cream pl-3.5 pr-3.5 py-3.5 rounded-full shadow-lg hover:bg-clay transition-colors sm:hover:pr-5"
    >
